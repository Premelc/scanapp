...
): Flow<R> = defaultCombine(flow, flow2, flow3, flow4, flow5) { args: Array<*> ->
...
inline fun <T1, T2, T3, T4, T5, T6, T7, T8, R> combine(
    ...
    defaultCombine(flow, flow2, flow3, flow4, flow5, flow6, flow7, flow8) { args: Array<*> ->
        @Suppress("UNCHECKED_CAST")
        transform(
            args[0] as T1,
            args[1] as T2,
...
inline fun <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> combine(
    ...
    defaultCombine(flow, flow2, flow3, flow4, flow5, flow6, flow7, flow8, flow9) { args: Array<*> ->
        @Suppress("UNCHECKED_CAST")
        transform(
            args[0] as T1,
            args[1] as T2,
